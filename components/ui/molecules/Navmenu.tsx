    ...
    <div className="w-full h-17 flex justify-between items-center border-b border-border py-5 px-8">
      <div className="flex items-center w-fit h-full justify-center gap-x-5">
        ...
        <div className="flex gap-x-4">
          <p className="text-black/40">Dashboards</p>
      ...
      <div className="flex items-center w-fit h-full justify-center gap-x-5">
        <div className="flex gap-x-4 items-center justify-center">
          <button
            type="button"
            className="w-40 h-7 px-3 rounded-md bg-black/5
             flex items-center justify-between
             gap-x-2"
          >
            <div className="flex gap-1 text-black/20 items-center justify-center">
              {" "}
