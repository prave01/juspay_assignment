...
export function TotalSales() {
  return (
    <div
      className="w-full max-w-[202px] bg-[#F7F9FB] h-[338px] dark:bg-[#272727]
        rounded-lg p-4 flex flex-col justify-between"
    >
      <h3 className="text-[14px] font-semibold text-primary">Total Sales</h3>

      <div
        className="h-[200px] w-full relative flex items-center justify-center"
      >
        ...
        <div
          className="absolute top-[65%] left-[10%] bg-black/80 text-white
            text-[10px] font-medium px-2 py-1 rounded-md transform
      ...
      <div className="space-y-4 px-4">
        {data.map((item) => (
          <div key={item.name} className="flex items-center justify-between">
            ...
            <span
              className="text-[12px] font-normal text-gray-600 dark:text-white"
            >
